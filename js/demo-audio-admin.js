(() => {
  ...
  function injectStyles(){
    ...
    st.textContent=`
      ...
      @media(max-width:850px){.demo-cert-layout,.fan-presence-grid{grid-template-columns:1fr}.fan-presence-panel.full{grid-column:auto}.fan-presence-toolbar{grid-template-columns:1fr}.fan-presence-list{max-height:none}}
    `;
  ...
  function boot(){
    ...
    if(isAdmin()){createCodesPage();createCheckinQrPage();}
